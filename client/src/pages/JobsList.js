  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-wurkzi-50 via-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-wurkzi-700 to-blue-700 bg-clip-text text-transparent mb-2">
            Available Jobs
          </h1>
        ...
        {jobs.length > 0 ? (
          <>
            <div className="mb-6 flex items-center justify-between">
              <p className="text-gray-600">
                <span className="font-semibold text-wurkzi-700">
                  {jobs.length}
                </span>
                  ...
                  >
                    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden h-full">
                      ...
                      {previewImage ? (
                        ...
                        <div className="h-48 bg-gradient-to-br from-wurkzi-100 to-blue-100 flex items-center justify-center">
                          <div className="text-center">
                            <svg
                              className="w-12 h-12 text-wurkzi-400 mx-auto mb-2"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                            ...
                            <p className="text-sm text-wurkzi-600">No images</p>
                          </div>
                          <div className="absolute top-3 right-3">
                            <StatusBadge status={job.status} type="job" />
                          </div>
                      ...
                      <div className="hidden h-48 bg-gradient-to-br from-wurkzi-100 to-blue-100 items-center justify-center">
                        <div className="text-center">
                          <svg
                            className="w-12 h-12 text-wurkzi-400 mx-auto mb-2"
                            fill="none"
                          ...
                          >
                            <path
                              ...
                              strokeLinejoin="round"
                              strokeWidth={2}
                              d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16M6 20h12a2 2 0 002-2V6a2 2 0 00-2 2v12a2 2 0 002 2z"
                            />
                          </svg>
                          <p className="text-sm text-wurkzi-600">
                            Image unavailable
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center text-wurkzi-600 font-medium group-hover:text-wurkzi-700">
                            View Details
                            <svg
          ...
          <div className="text-center py-16">
            <div className="bg-white rounded-2xl shadow-lg p-12 max-w-lg mx-auto">
              <div className="w-20 h-20 bg-gradient-to-br from-wurkzi-100 to-blue-200 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg
