      ...
      {isHirer ? (
          ...
          {applications.length > 0 ? (
            <div className="space-y-4">
              {applications.map((app) => (
                <div key={app.id} className="border border-gray-200 rounded-lg p-5 bg-gray-50">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">ID: {app.workerId.substring(0, 8)}...</p>
                        </div>
                      </div>
                      ...
                      {app.message && (
                        <div className="mt-3 p-3 bg-white rounded-md border">
                          <p className="text-sm text-gray-700">
                            <span className="font-medium text-gray-900">Message:</span> {app.message}
                          </p>
                        </div>
                      )}
                  ...
                  {app.status === "REJECTED" && (
                    <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-md">
                      <div className="flex items-center">
                        <svg className="w-5 h-5 text-red-600 mr-2" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center py-8">
              <svg className="w-16 h-16 text-gray-300 mx-auto mb-4" width="64" height="64" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-blue-900 mb-1">Application Deposit Required</p>
                      <p className="text-blue-800">
                        A $5 refundable deposit is required to apply. This deposit will be:
                      </p>
                      <ul className="mt-2 text-blue-700 list-disc list-inside space-y-1">
                        <li>Refunded if your application is rejected</li>
                        <li>Added to your final payment if you complete the job</li>
                      </ul>
                    </div>
                  </div>
                </div>
          ...
          {showPaymentForm && clientSecret && (
            <div className="card">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Complete Your Application</h3>
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm">Please complete the $5 deposit payment to finalize your application.</p>
              </div>
          ...
          {job.status !== "PENDING" && (
            <div className="card">
              <div className="text-center py-8">
                <svg className="w-10 h-10 text-gray-300 mx-auto mb-4" width="40" height="40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                <p className="text-gray-500 text-lg font-medium">Applications Closed</p>
